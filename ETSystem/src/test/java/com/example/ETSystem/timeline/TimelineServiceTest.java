...
class TimelineServiceTest{
	...
	void testUseEventData(){
		...
		TimelineData uRes = service.save(new UseEvent(epochUTC, ingredient, result, "warehouse 1", 10, null)).asData();
		assertTrue(uRes.data().containsKey("resultId"));
		assertEquals(uRes.data().get("resultId"), String.valueOf(result.getId()));
		...
		assertFalse(unRes.data().containsKey("resultId"));
