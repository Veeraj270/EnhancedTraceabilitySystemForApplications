...
const CustomerOrdersTable = () => {
    ...
    const handleGenerateClick = async (order: CustomerOrder) => {
        ...
        try {
            const response = await fetch('http://backend:8080/api/auto-order/auto-gen-orders', {
                method: 'POST',
                headers: {
    ...
    const handleConfirm = async () => {
        try {
            const response = await fetch('http://backend:8080/api/auto-order/auto-gen-orders/confirm', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
    ...
    const handleCancel = async () => {
        try{
            const response = await fetch('http://backend:8080/api/auto-order/auto-gen-orders/cancel', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const fetchData = async (): Promise<void> => {
        try {
            const response = await fetch('http://backend:8080/api/customerorders/fetch');
